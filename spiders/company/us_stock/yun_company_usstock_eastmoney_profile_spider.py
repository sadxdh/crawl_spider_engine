...
class YunUsCompanyProfileSpider(BaseSpider):
    name = 'yun_company_usstock_eastmoney_profile'
    headers = {
        'Accept': '*/*',
    ...
    data_table = 'listing_us_entity_info'
    custom_settings = {
    ...
    def parse(self, response, **kwargs):
        ...
        for data in datas:
            code = data['f12']
            for report_name in ['RPT_USF10_INFO_ORGPROFILE', 'RPT_USF10_INFO_SECURITYINFO']:
                params = {

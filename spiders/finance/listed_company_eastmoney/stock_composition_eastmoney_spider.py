...
# 股本结构 股本构成
class StockCompositionEastmoneySpider(BaseSpider):
    name = 'stock_composition_eastmoney'
    data_table = ''
    ...
    def parse_details(self, response, base_data):
        ...
        if json_data['result']:
            for data in json_data['result'].get('data', []):
                ...
                limited_shares = data['LIMITED_SHARES']  # 受限流通股份(股)
                ...
                main_item['_table'] = 'listing_stock_capital_structure'

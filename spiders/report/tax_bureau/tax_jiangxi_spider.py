"""国家税务总局江西省税务局公告爬虫 → entity_government_announcement
旧项目参照: data_crawl_server jiangxi_tax_spider.py
"""
...
class JiangxiTaxSpider(BaseSpider):
    name = 'report_tax_jiangxi'
    ...
    url = 'https://jiangxi.chinatax.gov.cn/module/web/jpage/dataproxy.jsp'
    website_source = '国家税务总局江西省税务局'

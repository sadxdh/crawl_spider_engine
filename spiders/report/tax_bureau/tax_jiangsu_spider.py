"""国家税务总局江苏省税务局公告爬虫 → entity_government_announcement
旧项目参照: data_crawl_server jiangsu_tax_spider.py
"""
...
class JiangsuTaxSpider(BaseSpider):
    name = 'report_tax_jiangsu'
    ...
    url = 'https://jiangsu.chinatax.gov.cn/module/web/jpage/dataproxy.jsp'
    website_source = '国家税务总局江苏省税务局'

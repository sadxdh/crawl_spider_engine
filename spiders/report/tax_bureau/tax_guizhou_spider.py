"""国家税务总局贵州省税务局公告爬虫 → entity_government_announcement
旧项目参照: data_crawl_server guizhou_tax_spider.py
"""
...
class GuizhouTaxSpider(BaseSpider):
    name = 'report_tax_guizhou'
    ...
    website_source = '国家税务总局贵州省税务局'

    def start_requests(self):
        for page in range(self.start_page, self.end_page + 1):
            url = 'https://guizhou.chinatax.gov.cn/xxgk/tzgg/index{}.html'
    ...
    def extract_detail(self, response):
        ...
        content = xpath_parse(html_text, '//div[@id="Zoom"]/div[last()]/preceding-sibling::div')
    ...
    def extract_attachment(self, response):
        ...
        rows = html_text.xpath('//div[@id="Zoom"]//p/a')
        for row in rows:

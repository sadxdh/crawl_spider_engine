"""国家税务总局宁夏自治区税务局公告爬虫 → entity_government_announcement
旧项目参照: data_crawl_server ningxia_tax_spider.py
"""
...
class NingxiaTaxSpider(BaseSpider):
    name = 'report_tax_ningxia'

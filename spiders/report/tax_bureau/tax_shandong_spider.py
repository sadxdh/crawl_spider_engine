"""国家税务总局山东省税务局公告爬虫 → entity_government_announcement
旧项目参照: data_crawl_server shandong_tax_spider.py
"""
...
class ShandongTaxSpider(BaseSpider):
    name = 'report_tax_shandong'
    ...
    headers = {
        ...
        'Referer': 'https://shandong.chinatax.gov.cn/col/col8706/index.html?number=A02&uid=219&pageNum=3',
    ...
    def generate_url(page):
        base_url = 'https://shandong.chinatax.gov.cn/col/col8706/index.html?number=A02&uid=219&pageNum={}'.format(page)
        return base_url

"""安徽省税务局公告爬虫 → entity_government_announcement
旧项目参照: data_crawl_server anhui_tax_spider.py
"""
...
class AnhuiTaxSpider(BaseSpider):
    name = 'report_tax_anhui'
    custom_settings = {
    ...
    headers = {
        ...
        "origin": "https://anhui.chinatax.gov.cn",
        "priority": "u=1, i",
    ...
    def extract_detail(self, response):
        ...
        xpath_content = '//div[@id="zoom"] | //div[@id="img-content"] | //div[contains(@class,"ls-article-info")] | //div[@class="TRS_Editor"] | //div[@id="fontzoom"]'
        try:
    ...
    def extract_attachment(self, response):
        ...
        rows = html_text.xpath('//div[contains(@id, "zoom")]/p[(a) and contains(text(), "附件")]/a[(text())]')
        for row in rows:
    ...
    def start_requests(self):
        for page in range(self.start_page, self.end_page + 1):
            ...
            url = "https://anhui.chinatax.gov.cn/module/web/jpage/dataproxy.jsp?" + urlencode(params)

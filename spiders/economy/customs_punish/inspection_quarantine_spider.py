...
# 海关走私违规行政处罚案件
class CustomsPunishInspectionQuarantineSpider(BaseSpider):
    name = 'customs_punish_inspection_quarantine'
    ...
    def start_requests(self):
        website_list = self.query_website(inspection_quarantine, region_name=self.region_name)

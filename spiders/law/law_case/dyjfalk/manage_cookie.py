...
from spiders.law.law_case.dyjfalk.generate_cookie import GenerateCookie


class ManageLawCaseDyCookies(ManageCookies):
    spider_name = 'law_case_dy'
    ...
    def get_cookie(self):
        ...
        if cookie_list:
            return self.random_cookie(cookie_list, lifetime=60*60*1)
        return None
